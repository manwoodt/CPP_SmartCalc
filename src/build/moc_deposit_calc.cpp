...
QT_MOC_LITERAL(37, 15) // "delete_all_text"
    ...
    "Deposit_calc\0firstWindow\0\0back\0equal\0"
    "delete_all_text"
};
...
void Deposit_calc::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Deposit_calc::firstWindow)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Deposit_calc, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
